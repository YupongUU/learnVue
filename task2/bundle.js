	...
	app = new _vue2.default({
	    ...
	    created: function created() {
	        ...
	        window.onbeforeunload = function () {
	            var dataString = JSON.stringify(_this2.todoList); // JSON 文档: https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/JSON
	    ...
	    methods: {
	        ...
	        login: function login() {
	            ...
	            _leancloudStorage2.default.User.logIn(this.formData.username, this.formData.password).then(function (loginUser) {
